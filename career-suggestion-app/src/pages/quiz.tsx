  ...
  return (
    <div className="min-h-screen bg-[rgba(10,10,10,1)] text-white p-6 relative">
      ...
      <div className="neon-card p-6 rounded-lg mt-24 mb-16">
        ...
        <div className="flex flex-col items-center gap-6"> {/* Increased gap for better spacing */}
          {/* Study Button */}
          <motion.button
            className="cta-button p-4 bg-transparent text-neon-green border-2 border-neon-green rounded-lg transition-all duration-300 hover:bg-neon-green hover:text-white hover:shadow-[0_0_20px_var(--neon-green), 0_0_10px_var(--neon-green)-inset]"
            whileHover={{ scale: 1.1 }}
            whileTap={{ scale: 0.95 }}
          ...
          {/* Find Job Button */}
          <motion.button
            className="cta-button p-4 bg-transparent text-neon-purple border-2 border-neon-purple rounded-lg transition-all duration-300 hover:bg-neon-purple hover:text-white hover:shadow-[0_0_20px_var(--neon-purple), 0_0_10px_var(--neon-purple)-inset]"
            whileHover={{ scale: 1.1 }}
            whileTap={{ scale: 0.95 }}
          ...
          {/* No Idea Button */}
          <motion.button
            className="cta-button p-4 bg-transparent text-neon-orange border-2 border-neon-orange rounded-lg transition-all duration-300 hover:bg-neon-orange hover:text-white hover:shadow-[0_0_20px_var(--neon-orange), 0_0_10px_var(--neon-orange)-inset]"
            whileHover={{ scale: 1.1 }}
            whileTap={{ scale: 0.95 }}
