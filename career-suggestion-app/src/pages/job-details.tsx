  ...
  return (
    <div className="min-h-screen bg-[rgba(10,10,10,1)] text-white p-6 relative">
      ...
      <div className="neon-card p-6 rounded-lg mt-24 mb-16">
        <h2 className="neon-heading text-3xl mb-6 text-center">Job Guidance Form</h2>
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <motion.button
            type="submit"
            className="cta-button p-3 mt-6 bg-transparent text-neon-purple border-2 border-neon-orange rounded-lg transition-all duration-300 hover:--neon-purple hover:text-white hover:shadow-[0_0_15px_var(--neon-lime)]"
