...
export default function StudyDetails() {
  ...
  const handleSubmit = (e: FormEvent) => {
    e.preventDefault();
    // Define required fields with explicit type
    const requiredFields: (keyof typeof formData)[] = [
      'name', 'age', 'location', 'educationStatus', 'subject', 'favoriteSubject',
      'pathway', 'opportunities', 'q1', 'q2', 'q3', 'q4', 'q5', 'q6', 'q7', 'q8', 'q9', 'q10'
    ];
    // Check if all required fields are filled
    const isFormValid = requiredFields.every(field => formData[field].trim() !== '');
    if (isFormValid) {
      // Pass form data as query parameters to Recommendations page
  ...
  return (
    <div className="min-h-screen bg-[rgba(10,10,10,1)] text-white p-6 relative">
      ...
      <div className="neon-card p-6 rounded-lg mt-24 mb-16">
        <h2 className="neon-heading text-3xl mb-6 text-center">Study Guidance Form</h2>
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <motion.button
            ...
            style={{ '--dark-blue': '#1E90FF' } as React.CSSProperties} // Dark Blue (DodgerBlue)
          >
            Submit
          </motion.button>
        </form>
